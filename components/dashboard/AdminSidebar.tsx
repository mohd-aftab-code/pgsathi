...
import {
  ...
  IndianRupee, ShieldAlert, Wallet, FileBarChart, MapPin, Activity, SlidersHorizontal,
} from "lucide-react";
...
const NAV: SidebarNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Program Rules", href: "/dashboard/admin/partner-program", icon: SlidersHorizontal, hideMobile: true },
    ],
  },
  {
    category: "System",
