        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6 pr-0 lg:pr-8">
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href="https://www.facebook.com/people/PG-Sathi/61592402880298/?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" 
                className="w-10 h-10 rounded-full bg-slate-800/80 flex items-center justify-center text-slate-400 hover:bg-[#1877F2] hover:text-white transition-all shadow-sm">
