/**
 * app/(main)/dashboard/owner/manage/payments/new/page.tsx
...
function RecordPaymentForm() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push("/dashboard/owner/manage/payments");
    } catch (err: any) {
    ...
    <form onSubmit={submit}>
      <div className="card p-6 max-w-lg mx-auto">
        ...
        <div className="mt-6 flex gap-3">
          <Link href="/dashboard/owner/manage/payments" className="btn-outline flex-1 text-sm text-center">Cancel</Link>
  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-3">
        <Link href="/dashboard/owner/manage/payments" className="grid h-9 w-9 place-items-center rounded-xl border border-neutral-200 bg-white hover:bg-neutral-50">
