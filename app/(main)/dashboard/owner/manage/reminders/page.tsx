/**
 * app/(main)/dashboard/owner/manage/reminders/page.tsx
          ...
          {pending.map(({ id, name, phone, listing, monthlyRent, paid, due }) => (
            <div key={id} className="card p-4 flex items-center justify-between gap-4 hover:shadow-md transition">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <Link href={`/dashboard/owner/manage/tenants/${id}`} className="font-semibold text-neutral-900 hover:underline">
                    {name}
                  </Link>
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <Link
                  href={`/dashboard/owner/manage/payments/new?tenantId=${id}`}
