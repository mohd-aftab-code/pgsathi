/**
 * app/(main)/dashboard/owner/manage/tenants/page.tsx
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        ...
        <Link href="/dashboard/owner/manage/tenants/new" id="add-tenant-btn" className="btn-primary text-sm">
      ...
      {tenants.length === 0 ? (
        <div className="card">
          <EmptyState
            ...
            actionHref="/dashboard/owner/manage/tenants/new"
          />
        </div>
      ) : (
        <>
                    ...
                    return (
                      <tr key={t.id} className="hover:bg-neutral-50 transition">
                        ...
                        <td className="px-4 py-3 text-right">
                          <Link href={`/dashboard/owner/manage/tenants/${t.id}`} className="text-xs font-semibold text-primary-700 hover:underline">
                            View →
                          </Link>
                        </td>
                      </tr>
