      ...
      <div className="container-max section-padding py-16 md:py-24">
        ...
        <section id="how-it-works" className="mb-24">
          <div className="bg-neutral-900 rounded-3xl md:rounded-[2.5rem] p-6 sm:p-8 md:p-16 overflow-hidden relative">
            <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-emerald-500/10 rounded-full blur-[80px] -translate-y-1/2 -translate-x-1/2"></div>
            
            <div className="text-center relative z-10 mb-12">
              <span className="text-emerald-400 font-bold tracking-wider uppercase text-sm mb-4 block">3 Simple Steps</span>
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-8 md:p-12 shadow-sm border border-neutral-200 mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-neutral-50 rounded-2xl p-8 border border-neutral-100 text-center">
              ...
              <Link href="/register" className="btn-primary bg-emerald-500 hover:bg-emerald-600 px-8 py-3.5 w-full block">
                Start Earning Now
              </Link>
            </div>
          </div>
