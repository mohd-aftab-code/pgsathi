...
export default async function AdminDashboardLayout({
  ...
  // Sits at the bottom of the desktop rail, where the Owner shell puts its plan
  // widget — who-am-I and logout stay in the same place across roles.
  const footer = (
    <div className="rounded-xl bg-white border border-violet-100 p-3 shadow-sm">
      ...
      {/* The default LogoutButton is a bare 36px icon — too easy to miss tucked
          into a card. Give it a labelled full-width shape here. */}
