  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 lg:mb-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-extrabold text-neutral-900 tracking-tight">Dashboard Overview</h1>
          <p className="text-sm md:text-base text-neutral-500 mt-1">Welcome back! Here is what's happening.</p>
        </div>
        <Link 
