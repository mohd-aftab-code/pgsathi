...
export default async function PaymentsPage({
  ...
  return (
    <div>
      ...
      {payments.length === 0 ? (
        <div className="card">
          <EmptyState icon={Wallet} title="Koi payment nahi" description="Is mahine koi payment record nahi hui abhi tak." actionLabel="Record Payment" actionHref="/dashboard/manager/payments/new" />
        </div>
      ) : (
