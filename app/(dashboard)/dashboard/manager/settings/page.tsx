  ...
  return (
    <div className="bg-white/60 backdrop-blur-md rounded-2xl md:rounded-3xl shadow-sm border border-neutral-200/60 p-4 sm:p-6 md:p-8">
      <div className="mb-6 lg:mb-8 border-b border-neutral-200/60 pb-5">
        <h1 className="text-2xl font-black text-neutral-900 tracking-tight uppercase flex items-center gap-2 uppercase">
      ...
      <div className="grid gap-6 max-w-2xl">
        <div className="bg-white/40 p-4 sm:p-6 rounded-2xl border border-neutral-200/40 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <div className="text-[9px] font-bold text-violet-600 bg-violet-50/80 border border-violet-200/60 px-2 py-0.5 rounded-xl inline-flex items-center gap-1 mt-1 uppercase tracking-wider">
            ...
            {phone && (
              <div className="flex items-center justify-between p-3 bg-white/60 backdrop-blur-md rounded-xl border border-neutral-200/60 shadow-sm">
                <div className="flex items-center gap-3">
                  <div className="bg-neutral-100/80 p-2 rounded-2xl border border-neutral-200/40">
        ...
        <div className="bg-white/60 backdrop-blur-md border border-red-200/60 rounded-2xl p-4 sm:p-6 shadow-sm">
          ...
          <div className="border-t border-red-200/40 pt-4 mt-2">
            ...
            <LogoutButton className="w-full flex justify-center py-3 bg-white/60 backdrop-blur-md border border-neutral-200/60 text-[10px] text-neutral-700 hover:bg-neutral-50 uppercase tracking-wider shadow-sm rounded-xl font-black" />
          </div>
        </div>
      </div>
    </div>
